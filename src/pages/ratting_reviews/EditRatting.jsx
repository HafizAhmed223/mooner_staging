...
const validationSchema = Yup.object().shape({
  ...
  // seeker_id: Yup.string().required("* Field is required"),
  ...
  const handleSubmit = (values) => {
    const payload = {
      ...
      rated_by:
        rattingById &&
        rattingById[0] &&
        rattingById[0].rated_by &&
        rattingById[0].rated_by,
      rated_to:
        rattingById &&
        rattingById[0] &&
        rattingById[0].rated_to &&
        rattingById[0].rated_to,
      booking:
        rattingById &&
        rattingById[0] &&
        rattingById[0].booking_id &&
        rattingById[0].booking_id,
    };
    updateRattingAction(payload, id);
  };
                      ...
                      >
                        ...
                        >
                          ...
                          <Select
                            ...
                            label="category"
                            displayEmptyclassName={classes.disableTextStyle}
                            disabled={true}
                            MenuProps={{
                              anchorOrigin: {
                                vertical: "bottom",
