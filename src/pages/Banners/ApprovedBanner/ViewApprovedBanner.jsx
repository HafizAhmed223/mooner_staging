...
const ViewApprovedBanner = () => {
  ...
  const handlechangeBack = () => {
    history.push({
      pathname: "/mooner/details/aproved_banner",
    });
  };
    ...
    <>
      <Container maxWidth="xl">
        <Grid container spacing={2}>
          <Grid item sm={12}>
            <Topbar
              module="Banner & Ad Management"
              item="View Approved Banner"
              bckLink="/mooner/details/aproved_banner"
            />
          </Grid>
        </Grid>
...
export default ViewApprovedBanner;
