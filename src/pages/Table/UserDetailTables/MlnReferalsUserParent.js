...
const MlnReferalsUserParent = (props) => {
          ...
          <>
            ...
            <div className={classes.container}>
              ...
              >
                <MenuItem>
                  <NavLink
                    to={`/mooner/view_mln_referral_user/${props.value}`}
...
export default MlnReferalsUserParent;
