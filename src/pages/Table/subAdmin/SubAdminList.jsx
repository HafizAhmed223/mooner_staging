...
const SubAdminList = () => {
  ...
  const getSubAdmins = async (currentPage) => {
    try {
          ...
          <>
            ...
            <div className={classes.container}>
              ...
              >
                {/* <MenuItem>
                  <NavLink
                    to={`/mooner/sub_admin/add_permissions/${prop.value}`}
                ...
                <MenuItem>
                  <NavLink
                    to={`/mooner/sub_admin/remove_permissions/${prop.value}`}
                    className={classes.links}
                  >
                    <div className={classes.FlexWrapper}>
                      <Typography className={classes.actionsLabel}>
