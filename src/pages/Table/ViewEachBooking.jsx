          ...
          <Grid container className={classes.mainContainer}>
            <Grid item xs={12} sm={12} md={12} lg={9} xl={10}>
              ...
              <Grid container className={classes.mainContainer}>
                ...
                <Box width={"100%"} border="1px solid #727478" padding={4} marginBottom={"50px"}>
                  <Grid container>
                    <Grid
                      item
                      xs={12}
                  ...
                  <Grid container>
                    ...
                    >
                      ...
                      >
                        <InputLabel id="demo-simple-select-outlined-label"></InputLabel>
                        <TextField variant="outlined" value={
                          booking?.total_tokens * booking?.token_price} />
                      </FormControl>
                    </Grid>
                  </Grid>
                </Box>
                ...
                <Box width={"100%"} border="1px solid #727478" padding={4} marginBottom={"50px"}>
                  <Grid container>
                    ...
                    >
                      <Typography className={classes.label} gutterBottom>
                        MLN Percentage of Platform Incentive
                      </Typography>
                      <FormControl
                        variant="outlined"
                        className={[classes.field, classes.removeOutline]}
...
export default ViewEachBooking;
