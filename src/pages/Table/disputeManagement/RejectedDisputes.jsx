...
import {
  rejectedDisputeAction,
  deleteRejectedDispute,
          ...
          <>
            ...
            {/* <div className={classes.container}>
                            ...
                            <ConformationModal
                                ...
                                actionName={open && deleteRejectedDispute}
                            />
                        </div>
                     */}
          </>
        ...
        {rejectedList && rejectedList.length > 0 ? (
          <>
            ...
            <TablePagination
              ...
              count={count}
              getPageDataAction={rejectedDisputeAction}
...
const mapStateToProps = ({ dispute }) => {
  return {
    rejectedList: dispute.rejectedDisputeList,
