...
import {
  allAprovedDisputeAction,
  deleteAprovedDispute,
...
const AprovedDisputeList = ({
  ...
  const COLUMNS = [
    ...
    //                         <MenuItem>
    //                             <NavLink
    //                                 to={`/mooner/edit_aprove_dispute/${props.value}`}
    //                                 className={classes.links}
    //                             >
    ...
    //                         actionName={open && deleteAprovedDispute}
    //                     />
    //                 </div>
    //             </>
    //         );
        ...
        {approveList && approveList.length > 0 ? (
          <>
            ...
            <TablePagination
              ...
              count={count}
              getPageDataAction={allAprovedDisputeAction}
...
const mapStateToProps = ({ dispute }) => {
  return {
    approveList: dispute.aproveDisputeList,
