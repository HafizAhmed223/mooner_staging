...
import { getCabBookingList } from "../../redux/actions/cabbooking/cabbooking.action";
...
const AllCabBooking = ({
  ...
  useEffect(() => {
    ...
    getCabBookingList(id, currentPage);
  }, []);
          ...
          <>
            ...
            <div className={classes.container}>
              ...
              >
                ...
                <MenuItem>
                  <div className={classes.FlexWrapper}>
                    <NavLink to={`/mooner/cab/`} className={classes.links}>
                      <Typography
                        className={classes.actionsLabel}
                        onClick={() => {
            ...
            <Grid item xs={12} sm={7} md={8} lg={9} xl={10}>
              <Grid container spacing={2} className={classes.header}>
                <Grid item xs={12} sm={4} md={4} lg={4} xl={6}>
                  <Typography className={classes.title}>All Cab Bookings</Typography>
                </Grid>
              ...
              {loading ? (
                ...
                <>
                {/* {console.log(bookingData,"all cab")} */}
                  {bookingData && bookingData.length > 0 ? (
                    <>
                      ...
                      <TablePagination
                        ...
                        count={count}
                        getPageDataAction={getCabBookingList}
                        id={id && id}
...
const mapStateToProps = ({ booking,capBooking, loader }) => {
  // console.log("booking====",capBooking)
  return {
    bookingData: capBooking.cabBooking,
    count: capBooking.count,
    next: capBooking.next,
    previous: capBooking.previous,
    loading: loader.loading,
  };
};
export default connect(mapStateToProps, { getCabBookingList, deleteBooking })(
  AllCabBooking
);
