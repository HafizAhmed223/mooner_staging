...
import {
  approved_kycCategorySpecficKycList,
...
const KycAnswers = ({
  ...
  useEffect(() => {
    approved_kycCategorySpecficKycList(1);
  }, []);
      ...
      <Grid xs={12} sm={12} md={12} lg={12} xl={12}>
        <Grid container spacing={5} className={classes.header}>
          ...
          >
            ...
            <ArrowRightIcon />
            <Typography className={classes.title2}>Approved Kyc</Typography>
          </Grid>
          <Grid
            item
            xs={12}
        ...
        {kycAnswersList && kycAnswersList.length > 0 ? (
          <>
            ...
            <TablePagination
              ...
              count={count}
              getPageDataAction={approved_kycCategorySpecficKycList}
