...
import {
  disapproved_kycCategorySpecficKycList,
  deleteKycAnswersAction,
...
const KycAnswers = ({
  ...
  useEffect(() => {
    disapproved_kycCategorySpecficKycList(1);
  }, []);
  ...
  const COLUMNS = [
    ...
    {
      Header: "Subchild",
      accessor: "sub_category_child_name",
    },
    {
      Header: "Status",
      accessor: "status",
          ...
          <>
            ...
            <div className={classes.container}>
              ...
              >
                <MenuItem>
                  <NavLink
                    to={`/mooner/edit_kyc_answer/${props.value}`}
              ...
              <ConformationModal
                ...
                actionName={open && deleteKycAnswersAction}
              />
            </div>
          </>
        );
  ...
  const handleAddkyc = () => {
    history.push("/mooner/common_documents");
  };
  return (
      ...
      <Grid xs={12} sm={12} md={12} lg={12} xl={12}>
        <Grid container spacing={5} className={classes.header}>
          ...
          >
            ...
            <ArrowRightIcon />
            <Typography className={classes.title2}>Disapproved Kyc</Typography>
          </Grid>
          <Grid
            item
            xs={12}
        ...
        <br />
        <br />
        {kycAnswersList && kycAnswersList.length > 0 ? (
          <>
            ...
            <TablePagination
              ...
              count={count}
              getPageDataAction={disapproved_kycCategorySpecficKycList}
...
const mapStateToProps = ({ categoryKycData }) => {
  return {
    kycAnswersList: categoryKycData.kycAnswersList,
