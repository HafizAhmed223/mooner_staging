          ...
          <>
            ...
            <div className={classes.container}>
              ...
              >
                <MenuItem>
                  <NavLink
                    to={`/mooner/view_category_kec/${props.value}`}
                ...
                <MenuItem>
                  <NavLink
                    to={`/mooner/edit_category_kec/${props.value}`}
                    className={classes.links}
                  >
                    <div className={classes.FlexWrapper}>
              ...
              <ConformationModal
                ...
                actionName={open && deleteCommonKycAction}
              />
            </div>
          </>
        );
      ...
      <Grid xs={12} sm={12} md={12} lg={12} xl={12}>
        <Grid container spacing={5} className={classes.header}>
          ...
          >
            ...
            <ArrowRightIcon />
            <Typography className={classes.title2}>Common Documents</Typography>
          </Grid>
          <Grid
            item
            xs={12}
        ...
        {commonList && commonList.length > 0 ? (
          <>
            ...
            <TablePagination
              ...
              count={count}
              getPageDataAction={getAllCommonKycList}
...
const mapStateToProps = ({ categoryKycData }) => {
  return {
    commonList: categoryKycData.commonKycList,
    // searchData: categoryKycData.filterData,
