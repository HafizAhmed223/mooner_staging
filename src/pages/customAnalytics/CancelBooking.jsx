...
const CancelBooking = ({ postBookingObject, cancelBookingList, id }) => {
  ...
  useEffect(() => {
    postBookingObject(id, 'total_no_cancelled_booking', page + 1);
  }, [id]);
  ...
  //     request_for: 'total_no_cancelled_booking'
  //   };
  //   try {
  ...
  return (
    <Box>
      <TableContainer>
        <Typography style={{ padding: "10px" }}>Total Num of Cancel Booking</Typography>
        <Table>
          <TableHead>
            <TableRow>
